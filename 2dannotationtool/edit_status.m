...
% Set label
rb0.String = 'Unknown'; % (default)
rb1.String = 'Ready';
rb2.String = 'Incomplete'; 
...
if strcmp(string(status), '1') % 'Ready'
    selected_rb = rb1;
elseif strcmp(string(status), '2') % 'Incomplete'
    selected_rb = rb2;
elseif strcmp(string(status), '0') % 'Unknown'
    selected_rb = rb0;
end

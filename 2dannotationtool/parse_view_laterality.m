function [view, laterality] = parse_view_laterality(dicomnfo) % Antti mod 3.4.2020
...
if strcmp(desc{1},'VIISTO') || strcmp(desc{1},'MLO') || ( sum(strcmp(fieldnames(dicomnfo), 'ViewPosition')) == 1 && strcmp(dicomnfo.ViewPosition,'RMLO') ) || ( sum(strcmp(fieldnames(dicomnfo), 'ViewPosition')) == 1 && strcmp(dicomnfo.ViewPosition,'LMLO') )
    view = 'MLO';

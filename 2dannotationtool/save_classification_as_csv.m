function save_classification_as_csv(handles_main) % A. I. mod 05.09.2021
...
T.Properties.VariableNames = {'Study','RightBenign','LeftBenign','RightMalignant','LeftMalignant'}; % A. I. mod 6.4.2020 
